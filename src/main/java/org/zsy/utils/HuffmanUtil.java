...
//        String tmp = new BigInteger(encodedBinariStr, 2).toString(10);
//        System.out.println(tmp);
//        System.out.println("-----1----");
//
//        oriStr = tmp;
//        statistics = statistics(oriStr.toCharArray());
//        encodedBinariStr = encode(oriStr, statistics);
//        System.out.println(oriStr);
//        System.out.println(encodedBinariStr);
//        tmp = new BigInteger(encodedBinariStr, 2).toString(10);
//        System.out.println(tmp);
...
//        tmp =new BigInteger(decodedStr, 2).toString(10);
//        System.out.println(tmp);
